...
# 该脚本用于处理经 UDG 处理或现代双端数据中 collapsed 部分，与参考基因组比对、过滤
# 需要准备 INPUT_LIST 文件：
# ERR4658035
# ERR4659298
...
do
    ...
    # 定义中间和最终文件路径
    INPUT_BAM="${run_id}.collapsed.bam"
    SORTED_BAM="${run_id}.collapsed.ARS1.mapping.sorted.bam" # 中间文件
    FINAL_BAM="${run_id}.collapsed.ARS1.mapping.sorted.MQ30.bam"
